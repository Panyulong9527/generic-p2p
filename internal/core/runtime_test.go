...
func TestRuntimeStatsPersistsRecentSelectionDecisions(t *testing.T) {
	...
	decision := SelectionDecision{
		...
		SelectedUDPDecisionRisk: "stable",
		SelectedUDPBudget:       5,
	...
	if snapshot.RecentDecisions[0].SelectedBurstProfile != "aggressive" || snapshot.RecentDecisions[0].SelectedLastStage != "piece" || snapshot.RecentDecisions[0].SelectedUDPDecisionRisk != "stable" || snapshot.RecentDecisions[0].SelectedUDPBudget != 5 || snapshot.RecentDecisions[0].SelectedUDPTimeoutMs != 5700 {
